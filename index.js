...
console.log(addArtist(artists, 'Zach Nemmers, `1995-2022`, "Web Design", "American", `I have a background in insurance and want to get into tech'))
...
function lotsOfArt(array) {
 ...
 for (let i = 0; i < array.length; i++){
  if (array[i].paintings > 100){
    hundredPeices.push(array[i].name)
  }
 }
 return hundredPeices
}
